 ...
 * 9.AES解密
 * 10.将base64 code AES解密
 */
public class BksxEncodeUtil {


    public static final String SIGN_ALGORITHMS = "SHA1PRNG";//签名算法
    public static void main(String[] args) throws Exception {
        String content = "{data:{'dwmc':'一二三四五六','ZZJGDM':'lskdjfsklfjlkj323424234','SSCXHM':'JJ@3234jksodf'}}";
        System.out.println("加密前：" + content);

        String key = "bksx|ourKey2018";
